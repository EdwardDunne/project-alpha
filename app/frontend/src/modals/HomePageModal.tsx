        ...
        <>
            ...
            <div
                className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white z-[1001]
                            ...
                            md:w-[50vw] md:p-[5rem] flex justify-start items-center flex-wrap"
            >
                <h1 className="text-center w-full text-[2.4rem] font-semibold">
                    {modal_title}
                </h1>
                <span className="text-center w-full">{content}</span>
                <span className="flex justify-end items-center w-full">
                    <button
                        className="px-5 py-2 bg-brand text-white rounded hover:bg-brand-dark
