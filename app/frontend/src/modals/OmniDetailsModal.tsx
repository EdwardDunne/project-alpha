...
const OmniDetailsModal: React.FC<Props> = ({ open, onClose, modalType, selectedBook, children }) => {

    const [omniDetails, setOmniDetails] = useState<OmniDetails>({
        contributors: [],
        publishDate: 'loading...',
        pages: 'loading...'
    });
    ...
    const scrapeAmazonDetails = async (book_url: string) => {
        const config = {
