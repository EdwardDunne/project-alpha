...
const ComicsAdmin: React.FC<Props> = ({
    ...
    const getMarvelOmnis = async (event: React.MouseEvent) => {
        event.preventDefault();
        get_marvel_omnis();
    }

    const scrapeDCOmnis = async (event: React.MouseEvent) => {
        event.preventDefault();
        scrape_dc_omnis();
    }

    const scrapeMarvelOmnis = async (event: React.MouseEvent) => {
        event.preventDefault();
        scrape_marvel_omnis();
    }
            ...
            <div style={leftSideContainer}>
                <div style={sideNavStyles}>
                    <ul style={sideNavListStyles}>
                        ...
                        <li style={sideNavItemStyles} onClick={getMarvelOmnis}>
                            <a href="#" style={sideNavLinkStyles}>
                                <i className="uil-book-alt"></i>
                                <span> Get Marvel Omnis</span>
                            </a>
                        </li>
                        <li style={sideNavItemStyles} onClick={scrapeDCOmnis}>
                            <a href="#" style={sideNavLinkStyles}>
                                <i className="uil-book-alt"></i>
                                <span> Scrape DC Omnis</span>
                            </a>
                        </li>
                        <li style={sideNavItemStyles} onClick={scrapeMarvelOmnis}>
                            <a href="#" style={sideNavLinkStyles}>
                                <i className="uil-book-alt"></i>
...
const bookItemContentStyles: React.CSSProperties = {
    display: 'flex',
...
const bookListItem: React.CSSProperties = {
    margin: '5px',
    width: '700px',
...
const contentTitleContainerStyles: React.CSSProperties = {
    height: '70px',
    display: 'flex',
    justifyContent: 'center',
    alignItems: 'center',
...
const sideNavLinkStyles: React.CSSProperties = {
    textDecoration: 'none',
    color: 'white',
}

const sideNavItemStyles: React.CSSProperties = {
    padding: '10px',
}

const sideNavListStyles: React.CSSProperties = {
    listStyle: 'none',
    padding: '0',
}
