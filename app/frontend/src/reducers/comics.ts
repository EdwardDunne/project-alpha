...
export default function comicsReducer(state: ComicsState = initialState, action: AnyAction): ComicsState {
        ...
        case LOAD_BOOKS_SUCCESS:
            return {
                ...
                all_books: [...payload.books]
                    .sort((a: Book, b: Book) => (a.title.toLowerCase() > b.title.toLowerCase()) ? 1
